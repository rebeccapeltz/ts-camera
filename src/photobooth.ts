...
abstract class PhotoBooth {
	...
	static pageCanvas: HTMLCanvasElement
	...
	static on_get_media = (stream: MediaStream) => {
		...
		PhotoBooth.pageCanvas = document.querySelector('#photo-downloaded')
	}
	...
	static take_photo() {
		...
		let ctx = PhotoBooth.pageCanvas.getContext('2d')
		ctx.drawImage(PhotoBooth.video, 0, 0, 150, 150*(PhotoBooth.canvas.height/PhotoBooth.canvas.width))
